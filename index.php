...
if ( is_category() && get_post_type() === 'post' ) {
	$wrapper_classes[] = 'flex-container items-wrapper';
}
...
?>
	<div class="<?php echo esc_attr( $container_class ); ?> archive-container">
		...
		<div class="row">
			...
			?>
			<div class="nv-index-posts blog col <?php echo (is_category() && get_post_type() === 'post') ? 'posts-listing-block' : ''; ?>">
				<?php
				/**
				...
				if ( have_posts() ) {
					...
					// Use custom post card for WordPress category archives
					if ( is_category() && get_post_type() === 'post' ) {
